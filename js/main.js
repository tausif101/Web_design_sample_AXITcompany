$(document).ready(function(){
    ...
    */
    ...
    //start header tab form
    
    
    $(".header-image-and-text .overlay-content .second-column .form-body form input").on("focus",function(){
            $(this).prev().css({
                    "top":"6px",
                    "transition":"500ms"
        })
    ...
    $(".header-image-and-text .overlay-content .second-column .form-body form input").on("blur",function(){
        var inputFieldValue = $(this).val();
